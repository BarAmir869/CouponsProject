...
// // Timestamp endDate = new Timestamp(startDate.getTime() + (1000 * 60 *
// ((int)
// // (Math.random() * 20))));
// // coupons.add(new Coupon(randomID, 1, Category.getRandom(), "My Coupon" + i,
// // "The test works fine!!",
// // startDate, endDate, (int) (Math.random() * 50), ((int) (Math.random() *
// 500)
// // / 10) * 10,
// // "no image yet"));
// // }
// // adminFacade.addCompany(new Company(1, "Bar Company", "bar@email.com",
// "1234",
// // coupons));
// // adminFacade.addCompany(
// // new Company(2, "Nir Company", "nir@email.com", "467925588",
// // getRandomListFrom(coupons)));
// // adminFacade.addCustomer(
// // new Customer(13, "Bar", "Amir", "bar@customer.com", "4321",
// // getRandomListFrom(coupons)));
// // adminFacade.addCustomer(
// // new Customer(20, "Noam", "Amir", "noam@customer.com", "9913487",
// // getRandomListFrom(coupons)));
// // adminFacade.updateCustomer(
// // new Customer(13, "Bar", "Amir", "bar@customer.com", "87654321",
// // getRandomListFrom(coupons)));
// // Thread.sleep(200000);
// // job.stopJob();
